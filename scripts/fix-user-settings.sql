-- Script para corrigir políticas RLS da tabela user_settings
...
BEGIN
  IF NOT EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'user_settings') THEN
    RAISE NOTICE 'Criando tabela user_settings...';
...
-- 9. Criar função RPC para criar configurações padrão
...
-- 11. Verificar se tudo foi configurado corretamente
SELECT 
...
SELECT 
  'Configurações de usuários:' as info,
